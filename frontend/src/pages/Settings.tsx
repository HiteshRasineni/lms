...
import { User, Mail, Bell, Award, HelpCircle, LogOut, Camera, Loader2, Trophy } from "lucide-react";
...
const Settings = () => {
  ...
  // Mock badges data
  const badges = [
    { id: 1, name: "Early Adopter", icon: "🚀", description: "Joined the platform early", earned: true },
    { id: 2, name: "Top Scorer", icon: "🏆", description: "Achieved 90+ in 5 assignments", earned: true },
    { id: 3, name: "Consistent Learner", icon: "📚", description: "7-day study streak", earned: true },
    { id: 4, name: "Course Completer", icon: "✅", description: "Completed 3 courses", earned: false },
    { id: 5, name: "Helpful Peer", icon: "🤝", description: "Helped 10 classmates in forums", earned: false },
    { id: 6, name: "Perfect Attendance", icon: "📅", description: "Attended all live classes", earned: false },
  ];
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button onClick={handleProfileUpdate} disabled={loading} data-testid="update-profile-btn">
                    {loading ? (
                      <>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Get notified of replies to your forum posts</p>
                  </div>
                  <Switch
                    id="forum-replies"
              ...
              <CardContent>
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    <div className="text-4xl font-bold text-primary">{xpData?.xp || 0} XP</div>
                    ...
                    <div className="mt-3">
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>{(xpData?.xp || 0) % 100}/100 XP to next level</span>
                      </div>
          ...
          <TabsContent value="help" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Get assistance and learn how to use the platform</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="border-t pt-4 mt-4">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>• Use the calendar to track your assignments and live classes</li>
                    <li>• Check the leaderboard to see how you rank among peers</li>
                    <li>• Participate in forum discussions to earn XP</li>
                    <li>• Complete assignments on time to maintain your streak</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
