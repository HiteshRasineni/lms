              ...
              {enrolledCourses.map((course) => (
                <div key={course.id} className="glass-card-light border-white/5 rounded-lg p-4 hover:bg-white/10 transition-all duration-300">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <Badge variant="outline" className="bg-primary/20 border-primary/30 text-primary-foreground">{course.nextClass}</Badge>
                  </div>
                ...
                {upcomingAssignments.map((assignment) => (
                  <div key={assignment.id} className="glass-card-light border-white/5 rounded-lg p-3 hover:bg-white/10 transition-all duration-300">
                    <div className="flex items-start justify-between">
                      ...
                      <Badge variant={assignment.status === "submitted" ? "secondary" : "default"} className={assignment.status === "submitted" ? "bg-success/20 border-success/30" : ""}>
                        {assignment.status}
                      </Badge>
                    </div>
                  </div>
