  ...
  return (
    <DashboardLayout userRole={user?.role === "Teacher" ? "teacher" : "student"}>
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2" data-testid="my-courses-title">
              My Courses
          </h1>
          <p className="text-muted-foreground">View and manage your enrolled courses.</p>
        </div>
        <Button onClick={() => navigate("/explore-courses")} data-testid="explore-courses-btn">
            ...
            return (
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full" data-testid="continue-learning-btn">
                    Continue Learning
                  </Button>
                </CardContent>
              </Card>
