...
export const CourseContent = ({ courseId }: CourseContentProps) => {
  ...
  const handleCreateTopic = async (unitId: string) => {
    ...
    try {
      ...
      if (topicFile) {
        formData.append("content", topicFile);
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => setShowNewTopic(showNewTopic === unit._id ? null : unit._id)}
          ...
          <CardContent className="space-y-3">
            {showNewTopic === unit._id && (
              <div className="border rounded-lg p-4 space-y-3 bg-muted/50">
                ...
                <div className="space-y-2">
                  <Label>Upload File (or enter URL below)</Label>
                  <Input
                    type="file"
                ...
                <div className="space-y-2">
                  <Label>Content URL (if not uploading file)</Label>
                  <Input
                    placeholder="Enter URL..."
                    value={newTopic.contentUrl}
                    onChange={(e) => setNewTopic({ ...newTopic, contentUrl: e.target.value })}
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" onClick={() => setShowNewTopic(null)}>
                    Cancel
                  </Button>
                </div>
              </div>
